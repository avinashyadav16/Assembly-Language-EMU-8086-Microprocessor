...
MAIN PROC             ; Starts the "main" procedure
    ...
    CMP AL, 'a'       ; Compare the character in AL with 'a'
    JB NOT_LOWERCASE  ; If the character is below 'a', it is not a lowercase letter
    CMP AL, 'z'       ; Compare the character in AL with 'z'
    JA NOT_LOWERCASE  ; If the character is above 'z', it is not a lowercase letter
