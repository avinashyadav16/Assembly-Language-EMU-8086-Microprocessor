...
MAIN PROC       ; Starts the "main" procedure
    ...
    MOV AH, 1       ; Move the value 1 into the AH register (AH is used for input operations)
    INT 21H         ; Call the DOS interrupt 21h, which reads a character from the keyboard into the AL register
    ...
    INT 21h         ; Call the DOS interrupt 21h, which prints the character in the DL register
                    ; (which is now the lowercase version of the character printed earlier)
